...
func TestToolSummary_Read(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Read", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Write(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Write", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Edit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Edit", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Bash(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Bash", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Grep(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Grep", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Glob(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Glob", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Task(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Task", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Skill(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("Skill", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_WebFetch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("WebFetch", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_WebSearch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("WebSearch", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_SendMessage(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("SendMessage", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_TaskCreate(t *testing.T) {
	got := tools.ToolSummary("TaskCreate", json.RawMessage(`{"subject":"Fix the build"}`))
	if got != "Fix the build" {
		t.Errorf("got %q, want %q", got, "Fix the build")
	}

	got = tools.ToolSummary("TaskCreate", json.RawMessage(`{}`))
	if got != "Create task" {
...
func TestToolSummary_TaskUpdate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("TaskUpdate", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_NilInput(t *testing.T) {
	got := tools.ToolSummary("Read", nil)
	if got != "Read" {
...
func TestToolSummary_EmptyInput(t *testing.T) {
	got := tools.ToolSummary("Read", json.RawMessage(``))
	if got != "Read" {
...
func TestToolSummary_MalformedJSON(t *testing.T) {
	got := tools.ToolSummary("Bash", json.RawMessage(`{not json}`))
	if got != "Bash" {
...
func TestToolSummary_DefaultWithCommonFields(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary(tt.tool, json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_Truncation(t *testing.T) {
	...
	got := tools.ToolSummary("Bash", json.RawMessage(`{"command":"`+longCmd+`"}`))
	if len([]rune(got)) > 60 {
...
func TestToolSummary_NewlinesCollapsed(t *testing.T) {
	...
	got := tools.ToolSummary("Bash", json.RawMessage(`{"command":"echo hello\necho world"}`))
	if got != "echo hello echo world" {
		t.Errorf("newlines not collapsed: got %q", got)
	}

	// Description with newlines.
	got = tools.ToolSummary("Bash", json.RawMessage(`{"description":"Build and\nrun tests"}`))
...
func TestToolSummary_NotebookEdit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("NotebookEdit", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_TodoWrite(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("TodoWrite", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestToolSummary_LSP(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ToolSummary("LSP", json.RawMessage(tt.input))
			if got != tt.want {
...
func TestShortPath(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.ShortPath(tt.path, tt.segments)
			if got != tt.want {
...
func TestTruncateWord(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := tools.TruncateWord(tt.input, tt.maxLen)
			if got != tt.want {
